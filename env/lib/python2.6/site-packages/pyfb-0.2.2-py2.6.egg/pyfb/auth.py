...
USER_ALL_PERMISSIONS = [_var for _var in dir() if _var.startswith("USER_")]
...
FRIENDS_ALL_PERMISSIONS = [_var for _var in dir() if _var.startswith("FRIENDS_")]
...
WRITE_ALL_PERMISSIONS = [_var for _var in dir() if _var.startswith("WRITE_")]

#Page related permissions

PAGE_MANAGE_PAGES = "manage_pages"

PAGE_ALL_PERMISSIONS = [_var for _var in dir() if _var.startswith("PAGE_")]

#All permisssions

ALL_PERMISSIONS = [_var for _var in dir() if not _var.startswith("_") and isinstance(_var, str)]
