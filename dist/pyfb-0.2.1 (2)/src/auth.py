...
USER_PERMISSIONS = [var for var in dir() if var.startswith("USER_")]
...
FRIENDS_PERMISSIONS = [var for var in dir() if var.startswith("FRIENDS_")]
...
WRITE_PERMISSIONS = [var for var in dir() if var.startswith("WRITE_")]

#Page related permissions

PAGE_MANAGE_PAGES = "manage_pages"

PAGE_PERMISSIONS = [var for var in dir() if var.startswith("PAGE_")]

#All permisssions

ALL_PERMISSIONS = [var for var in dir() if not var.startswith("_")]
